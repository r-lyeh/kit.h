...
GL3W_API /*extern*/ union ImGL3WProcs imgl3wProcs; //< @r-lyeh: expect `extern` to be defined in GL3W_API
...
/*GL3W_API*/ union ImGL3WProcs imgl3wProcs; //< @r-lyeh: GL3W_API already declared
