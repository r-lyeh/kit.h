...
/*extern*/ IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam);                // Use ImGui::GetCurrentContext() //< @r-lyeh: expect `extern` to be defined in IMGUI_IMPL_API
/*extern*/ IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandlerEx(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam, ImGuiIO& io); // Doesn't use ImGui::GetCurrentContext() //< @r-lyeh: expect `extern` to be defined in IMGUI_IMPL_API
