...
KIT void* canvas_handle(int id);
KIT int   canvas_create(int id);
KIT int    canvas_ready(int id);
KIT void    canvas_clear(int id, unsigned color);
KIT int    canvas_swap(int id);
KIT int    canvas_destroy(int id);
KIT int   canvas_count();
